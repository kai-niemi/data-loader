...
public class Application implements PromptProvider {
    private static void printHelpAndExit(String message) {
        System.out.println("Usage: java --jar dl.jar <options> [args..]");
        System.out.println();
        System.out.println("Options:");
        System.out.println("--help                    this help");
        System.out.println("--streaming               enable http streaming listener for IMPORT/COPY commands");
    ...
    public static void main(String[] args) {
        ...
        while (!argsList.isEmpty()) {
            ...
            if (arg.equals("--help")) {
                printHelpAndExit("");
            } else if (arg.equals("--streaming")) {
                profiles.add(ProfileNames.STREAMING);
        ...
        new SpringApplicationBuilder(Application.class)
                .web(profiles.contains(ProfileNames.STREAMING)
    ...
    public AttributedString getPrompt() {
        return new AttributedString("dl:$ ",
